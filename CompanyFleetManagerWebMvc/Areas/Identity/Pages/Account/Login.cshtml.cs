...
namespace CompanyFleetManagerWebApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(ILogger<LoginModel> logger, WebServiceAuthenticationApi webService)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, $"Invalid login attempt. {result.ErrorMessage}");
                    return Page();
                }
            }
